...
const adsServices = googleads_1.google.ads.googleads.v15.services;
const longrunningServices = googleads_1.google.longrunning;
const services = { ...longrunningServices, ...adsServices };
const resources = googleads_1.google.ads.googleads.v15.resources;
...
function parseGoogleAdsErrorFromMetadata(metadata) {
    ...
    return failureArray.map((bytes) => googleads_1.google.ads.googleads.v15.errors.GoogleAdsFailure.decode(bytes));
}
