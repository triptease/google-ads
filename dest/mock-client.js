...
var TrackingCodeType = google_proto_1.google.ads.googleads.v10.enums.TrackingCodeTypeEnum.TrackingCodeType;
var TrackingCodePageFormat = google_proto_1.google.ads.googleads.v10.enums.TrackingCodePageFormatEnum.TrackingCodePageFormat;
    ...
    async search(params) {
        ...
        if (params.filters !== undefined) {
            resources = resources.filter((gResource) => {
                const gResourceStringed = google_proto_1.google.ads.googleads.v10.resources[params.resource].toObject(gResource, {
                    enums: String,
                });
